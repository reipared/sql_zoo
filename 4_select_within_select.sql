...
WHERE population > (SELECT name FROM world
...
SELECT name, continent, population FROM world z
WHERE z.continent IN (SELECT DISTINCT continent FROM world x
